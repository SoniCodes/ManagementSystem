...
public class MongoDBConnection
{
    ...
    private MongoDBConnection()
    {
        ...
        this.medicalSystemDB = this.mongoClient.getDatabase("MedicalSystemDB");
    ...
    public ArrayList<Document> getReports(){
        ArrayList<Document> documents = new ArrayList<>();
        this.reports.find().forEach(documents::add);
        return documents;
    }

    public void removeReport(UUID uuid)
    {
        this.reports.deleteOne(new Document("UUID", uuid.toString()));
    }
}